...
const arm_cfft_instance_f64 arm_cfft_sR_f64_len8192 ARM_DSP_TABLE_ATTRIBUTE = {
  8192, (const float64_t*)twiddleCoefF64_8192, armBitRevIndexTableF64_8192, ARMBITREVINDEXTABLEF64_4096_TABLE_LENGTH
};
...
const arm_cfft_instance_q31 arm_cfft_sR_q31_len8192 ARM_DSP_TABLE_ATTRIBUTE = {
  8192, twiddleCoef_8192_q31, armBitRevIndexTable_fixed_8192, ARMBITREVINDEXTABLE_FIXED_8192_TABLE_LENGTH
};
...
const arm_cfft_instance_q15 arm_cfft_sR_q15_len8192 ARM_DSP_TABLE_ATTRIBUTE = {
  8192, twiddleCoef_8192_q15, armBitRevIndexTable_fixed_8192, ARMBITREVINDEXTABLE_FIXED_8192_TABLE_LENGTH
};

const arm_cfft_instance_q15 arm_cfft_sR_q15_len16384 ARM_DSP_TABLE_ATTRIBUTE = {
  16384, twiddleCoef_16384_q15, armBitRevIndexTable_fixed_16384, ARMBITREVINDEXTABLE_FIXED_16384_TABLE_LENGTH
}; // findme
...
const arm_rfft_instance_q31 arm_rfft_sR_q31_len16384 ARM_DSP_TABLE_ATTRIBUTE = {
  16384U,
  0,
  1,
  1U,
...
const arm_rfft_instance_q15 arm_rfft_sR_q15_len16384 ARM_DSP_TABLE_ATTRIBUTE = {
  16384U,
  0,
  1,
  1U,
